    ...
    async def on_message(self, message):
        ...
        if message.reference and message.reference.message_id:
            try:
                ...
                ref_msg = None
            message_reference = (ref_msg.author.id == 1442229230384709752 and "What's your answer? Feel free to share your thoughts, stories, or hot takes!" not in ref_msg.content and ref_msg.content) if ref_msg else False
